init -1 python hide:
    ...
    config.window_title = u"亲吻那片花瓣——画室的恋人们"
    config.name = "A Kiss For The Petals - Lovers of the Atelier"
    config.version = "1.01"
...
python early:
    config.save_directory = "HANA12"


init python:
    build.directory_name = "HANA12"
    build.executable_name = "HANA12"
